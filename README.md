...
* Similar to vim, in normal mode, your cursor should NOT exceed the end of a line and the end of the file; whereas in insert mode, your cursor should BE ABLE TO exceed the end of a line and the end of the file. Therefore, if you switch from insert mode to normal mode, your cursor should go back a column. 
