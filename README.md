...
* $\rightarrow$ and $\leftarrow$ are not allowed to jump to the next/previous line when at the end/beginning of a line. Under all circunstances, the information window should display the real `Cursor line and column`.
